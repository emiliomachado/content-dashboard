...
import {
  ...
  Users, Search, ExternalLink, ChevronRight, ChevronDown as ChevronDownIcon,
  AlertCircle,
} from "lucide-react";
...
const seedCompetitors: Competitor[] = [
  {
    id: "1", name: "Biofourmis", category: "Health Tech", website: "biofourmis.com",
    accounts: [
      { platform: "LinkedIn", handle: "@biofourmis", followers: 28400, growthPct: 2.1, engagementRate: 3.8, postsPerWeek: 4, lastPost: "2026-04-05",
        recentPosts: [
      ...
      { platform: "Instagram", handle: "@biofourmis", followers: 4200, growthPct: 1.4, engagementRate: 2.1, postsPerWeek: 2, lastPost: "2026-04-03",
        recentPosts: [
          { title: "Team spotlight: data science at Biofourmis", date: "Apr 3", likes: 88, comments: 6, type: "Single Image" },
          { title: "Product demo: Biovitals platform walkthrough", date: "Mar 30", likes: 102, comments: 9, type: "Reel" },
        ],
      },
    ],
  },
  {
    id: "2", name: "Vivify Health", category: "Health Tech", website: "vivifyhealth.com",
    accounts: [
      { platform: "LinkedIn", handle: "@vivifyhealth", followers: 14600, growthPct: 1.3, engagementRate: 2.9, postsPerWeek: 3, lastPost: "2026-04-04",
        recentPosts: [
          ...
          { title: "Vivify + Epic integration now live", date: "Mar 28", likes: 91, comments: 14, type: "Post" },
        ],
      },
      { platform: "YouTube", handle: "@vivifyhealthtv", followers: 1800, growthPct: 0.8, engagementRate: 1.6, postsPerWeek: 1, lastPost: "2026-03-25",
        recentPosts: [
          { title: "How RPM works: patient onboarding demo", date: "Mar 25", likes: 34, comments: 7, type: "Video" },
          { title: "Connected care platform overview 2026", date: "Mar 10", likes: 41, comments: 5, type: "Video" },
        ],
      },
    ],
  },
  {
    id: "3", name: "TytoCare", category: "Health Tech", website: "tytocare.com",
    accounts: [
      { platform: "LinkedIn", handle: "@tytocare", followers: 21300, growthPct: 3.2, engagementRate: 4.5, postsPerWeek: 5, lastPost: "2026-04-06",
        recentPosts: [
          ...
          { title: "New partnership with Kaiser Permanente announced", date: "Mar 31", likes: 204, comments: 48, type: "Post" },
        ],
      },
      { platform: "Instagram", handle: "@tytocare", followers: 8900, growthPct: 2.8, engagementRate: 3.7, postsPerWeek: 4, lastPost: "2026-04-05",
        recentPosts: [
          { title: "Behind the scenes: building TytoHome device", date: "Apr 5", likes: 312, comments: 28, type: "Reel" },
          { title: "Telehealth exam in 5 minutes — patient story", date: "Apr 1", likes: 278, comments: 19, type: "Carousel" },
        ],
      },
      { platform: "YouTube", handle: "@tytocaretv", followers: 5400, growthPct: 2.1, engagementRate: 3.2, postsPerWeek: 2, lastPost: "2026-04-02",
        recentPosts: [
          { title: "Full telehealth exam walkthrough with TytoHome", date: "Apr 2", likes: 89, comments: 22, type: "Video" },
          { title: "Dr. review: AI-assisted diagnosis accuracy", date: "Mar 28", likes: 114, comments: 31, type: "Video" },
        ],
      },
    ],
  },
  {
    id: "4", name: "VetRec", category: "Pet Health", website: "vetrec.ai",
    accounts: [
      { platform: "LinkedIn", handle: "@vetrec", followers: 3800, growthPct: 5.4, engagementRate: 6.2, postsPerWeek: 4, lastPost: "2026-04-05",
        recentPosts: [
      ...
      { platform: "Instagram", handle: "@vetrec.ai", followers: 2100, growthPct: 7.1, engagementRate: 5.8, postsPerWeek: 3, lastPost: "2026-04-04",
        recentPosts: [
          { title: "Vet clinic transformation with AI notes", date: "Apr 4", likes: 187, comments: 22, type: "Reel" },
          { title: "Meet the team building VetRec", date: "Apr 1", likes: 143, comments: 14, type: "Carousel" },
        ],
      },
    ],
  },
  {
    id: "5", name: "PetDesk", category: "Pet Health", website: "petdesk.com",
    accounts: [
      { platform: "LinkedIn", handle: "@petdesk", followers: 6200, growthPct: 1.8, engagementRate: 2.7, postsPerWeek: 3, lastPost: "2026-04-03",
        recentPosts: [
          ...
          { title: "New feature: two-way SMS for vet practices", date: "Mar 27", likes: 62, comments: 11, type: "Post" },
        ],
      },
      { platform: "Instagram", handle: "@petdesk", followers: 11400, growthPct: 2.4, engagementRate: 4.1, postsPerWeek: 5, lastPost: "2026-04-06",
        recentPosts: [
          ...
          { title: "Behind the scenes at a busy vet clinic", date: "Apr 2", likes: 448, comments: 29, type: "Reel" },
        ],
      },
    ],
  },
  {
    id: "6", name: "Digitail", category: "Pet Health", website: "digitail.io",
    accounts: [
      { platform: "LinkedIn", handle: "@digitail", followers: 4100, growthPct: 4.2, engagementRate: 5.1, postsPerWeek: 4, lastPost: "2026-04-05",
        recentPosts: [
          ...
          { title: "Customer story: 3x efficiency at Pet Clinic Lisbon", date: "Mar 30", likes: 112, comments: 22, type: "Post" },
        ],
      },
      { platform: "Instagram", handle: "@digitail.io", followers: 3200, growthPct: 6.3, engagementRate: 5.9, postsPerWeek: 4, lastPost: "2026-04-04",
        recentPosts: [
          { title: "Team in Lisbon celebrating 500 clinics milestone", date: "Apr 4", likes: 421, comments: 38, type: "Single Image" },
          { title: "Digitail app walkthrough for vet owners", date: "Apr 1", likes: 289, comments: 24, type: "Reel" },
        ],
      },
    ],
  },
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md bg-gray-900 border-gray-700 text-gray-100">
        <DialogHeader>
          <DialogTitle className="text-gray-100">Add Competitor</DialogTitle>
        </DialogHeader>
...
// ── Expanded row: accounts + recent posts ──────────────────────────────────
          ...
          <div key={acc.platform + acc.handle} className="space-y-2">
            ...
            {acc.recentPosts.length > 0 ? (
              ...
              <div className="flex items-center gap-1.5 text-xs text-gray-500 py-1">
                ...
                No post data yet — connect Metricool to pull live data.
              </div>
            )}
          </div>
        );
...
export default function CompetitorsPage() {
  ...
  function handleAdd(c: Competitor) { setCompetitors(prev => [c, ...prev]); }

  // Flatten to one row per competitor × account for sorting
  const flatRows = useMemo(() => {
    return competitors.flatMap(c =>
      c.accounts
        .filter(a => filterPlatform === "All" || a.platform === filterPlatform)
        .map(a => ({ competitor: c, account: a }))
    ).filter(r => {
      const q = search.toLowerCase();
      return (
        (filterCategory === "All" || r.competitor.category === filterCategory) &&
        (r.competitor.name.toLowerCase().includes(q) || r.account.handle.toLowerCase().includes(q))
      );
    }).sort((a, b) => {
  ...
  }, [competitors, search, filterPlatform, filterCategory, sortField, sortDir]);

  const Th = ({ field, label, className }: { field: SortField; label: string; className?: string }) => (
    <th
      className={cn("px-4 py-3 text-left text-xs font-medium text-gray-400 cursor-pointer select-none whitespace-nowrap", className)}
    ...
    <div className="min-h-full bg-gray-950 -m-6 p-6 space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-0.5">Health Tech · Pet Health — cross-platform intelligence</p>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-48 max-w-64">
          ...
          <Input
            ...
            className="pl-8 h-8 text-xs bg-gray-800 border-gray-700 text-gray-100 placeholder:text-gray-500"
            value={search}
            onChange={e => setSearch(e.target.value)}
          />
        </div>
        <Select value={filterPlatform} onValueChange={v => setFilterPlatform(v as Platform | "All")}>
          <SelectTrigger className="h-8 w-36 text-xs bg-gray-800 border-gray-700 text-gray-300"><SelectValue placeholder="Platform" /></SelectTrigger>
          <SelectContent className="bg-gray-800 border-gray-700 text-gray-100">
        ...
        <Select value={filterCategory} onValueChange={v => setFilterCategory(v as Category | "All")}>
          <SelectTrigger className="h-8 w-40 text-xs bg-gray-800 border-gray-700 text-gray-300"><SelectValue placeholder="Category" /></SelectTrigger>
          <SelectContent className="bg-gray-800 border-gray-700 text-gray-100">
            <SelectItem value="All">All Categories</SelectItem>
            {ALL_CATEGORIES.map(c => <SelectItem key={c} value={c}>{c}</SelectItem>)}
          </SelectContent>
        </Select>
        <span className="text-xs text-gray-500 ml-auto">{flatRows.length} accounts</span>
      </div>
      ...
      <p className="text-xs text-gray-600 flex items-center gap-1.5">
        <AlertCircle className="h-3.5 w-3.5" />
        Data is sample-seeded. Connect Metricool or a social API to pull live competitor metrics.
      </p>
    </div>
  );
}
